...
export default function Upload() {
    ...
    return (
        <div className="flex flex-col gap-3 border-2 border-black rounded-md p-3 w-full h-full flex-shrink-0 hover:bg-gray-50 cursor-pointer"> 
            ...
            {/* Drag & Drop Area */}
            {/* <div 
                className={`flex flex-col gap-2 border-2 rounded-lg p-4 text-center transition-colors ${
                    isDragOver 
            ...
            {file && !isUploading && (
                <button 
                    ...
                    className="w-full px-3 py-1 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors disabled:opacity-50 text-sm"
                >
                    Upload File
                </button>
            )}
            ...
            {uploadedFile && (
                <div className="border border-green-200 rounded-md p-2 bg-green-50">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <div className="flex-1">
                            <p className="font-medium text-green-800 text-sm">Upload Successful!</p>
